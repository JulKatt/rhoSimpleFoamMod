...
#include "KarrenbergWLFTransport.H"
#include "IOstreams.H"

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<class Thermo>
Foam::scalar Foam::KarrenbergWLFTransport<Thermo>::readCoeff
(
...
template<class Thermo>
Foam::KarrenbergWLFTransport<Thermo>::KarrenbergWLFTransport(const dictionary& dict)
:
    Thermo(dict),
...
template<class Thermo>
void Foam::KarrenbergWLFTransport<Thermo>::write(Ostream& os) const
{
